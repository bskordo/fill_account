...
def write_infromation_into_file(my_file, inf_fr_jsn,stop_inf_dadata, gos_contracts):
    ...
    work_sheet['G111'] = 'нет'#TODO need to clarify
    #Сумма заемных средств более 70% от валюты баланса на последнюю отчетную дату
    work_sheet['G112'] = 'нет'#TODO need to clarify
    #Наличие убытка в годовой отчетности
    work_sheet['G113'] = 'нет'##???
    #Срок существования компании
    work_sheet['G114'] = 'нет'
    #Наличие ранее принятых в отношении клиента решений об отказе в выполнении его
    work_sheet['G115'] = 'нет'
    #Гарантия на срок свыше 24 месяцев 
    work_sheet['G116'] = 'нет'
    #Максимальный размер снижения НМЦ контракта: 40%
    work_sheet['G117'] = 'нет'
    #Максимальный размер аванса по контракту : 35% от цены контракта. 
    work_sheet['G118'] = 'нет'
    #Срок регистрации Принципала при получении гарантии по авансовому контракту - не менее 1 года 
    work_sheet['G119'] = 'нет'
    #Сумма заемных средств более 70% от валюты баланса на последнюю отчетную дату
    work_sheet['G120'] = 'нет'
